...
//   2. Cloudflare Pages: the app lives under /app (oignon.dev root is the
...
//
// Note: we intentionally do NOT read a DEPLOY_BASE env var. The Cloudflare Pages
// project still has a stale DEPLOY_BASE=/ from the initial setup; honoring it
// would override /app/ and serve the app with root-relative asset paths (404).
const webBase = cfPages ? '/app/' : '/oignon/'
