...
<template>
  <div v-if="displayNode && store.hasGraph" class="details-panel">
    ...
    <div class="panel-header-row">
      ...
      <button v-else class="build-badge" @click="handleBuild" title="Build graph from this paper">
        Build
      </button>
      <span v-if="displayNode.metadata.openAccess" class="oa-badge" title="Open Access">OA</span>
    </div>
    ...
    <div v-if="displayNode.metadata.authors.length" class="paper-authors">
      <span
        ...
        class="paper-author"
      >
        {{ author }}<span v-if="i < Math.min(displayNode.metadata.authors.length, 5) - 1">, </span>
      </span>
    ...
    <div class="paper-stats">
      ...
      <div class="stat-row">
        ...
        <span class="stat-value">{{ displayNode.metadata.citationCount.toLocaleString() }}</span>
      </div>
      <div class="stat-row">
      ...
      <div v-if="displayNode.metadata.referencesCount" class="stat-row">
        ...
        <span class="stat-value">{{ displayNode.metadata.referencesCount.toLocaleString() }}</span>
      </div>
